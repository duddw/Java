...
public class Somador_de_Matrizes {
    static void main() {
        ...
        // realizar a verificação de possibilidade de soma de ambas.
        System.out.println("Seja bem vindo ao somador de Matrizes MxN!");
        ...
        // Utiliza uma condicional para verificar se é possível realizar a soma
        ...
        if(matriz1_M == matriz2_M && matriz1_N == matriz2_N){
            ...
            int[][] matriz3 = new int[matriz1_M][matriz2_N];
                ...
                // Utiliza laços de repetição para realizar a soma, atribuir os valores e exibi-los
            ...
            // Define uma mensagem caso a condição seja falsa para avisar o usuário
            // o motivo do código não ter sido executado.
            System.out.println("Não é possível realizar a soma das matrizes.");
